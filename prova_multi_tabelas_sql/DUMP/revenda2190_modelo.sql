...
CREATE TABLE `modelo` (
  ...
  CONSTRAINT `modelo_ibfk_1` FOREIGN KEY (`codigo_marca`) REFERENCES `marca` (`codigo_marca`)
...
INSERT INTO `modelo` VALUES (1,'Spider',1),(2,'Hercules',2),(3,'Zonda',3),(4,'Hayaka',4),(5,'Huracan',5);
